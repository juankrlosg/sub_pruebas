...
!function (t, e) {
    ...
    var v = {}, g = function (t) {
        ...
        yt = function () {
            ...
            var e,
                n = !!(e = O()) && (e.remove(), rt([document.documentElement, document.body], [y["no-backdrop"], y["toast-shown"], y["has-column"]]), !0);
    ...
    var xt = {innerParams: new WeakMap, domCache: new WeakMap},
        St = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Lt = function (t) {
            if (t.input) if (qt[t.input]) {
                var e = Ht(t.input), n = qt[t.input](e, t);
            ...
            if (n.inputLabel) {
                var o = document.createElement("label"), i = y["input-label"];
    ...
    function he(t) {
        t = ye(t);
        var e = re.swalPromiseResolve.get(this), n = ve(this);
    ...
    var Le = function t(e) {
        ...
        (n.showLoaderOnDeny && ke(U()), n.preDeny) ? (t.isAwaitingPromise = !0, Promise.resolve().then((function () {
            ...
            !1 === n ? (t.hideLoading(), be(t)) : t.close({isDenied: !0, value: void 0 === n ? e : n})
        })).catch((function (e) {
            return qe(t || je, e)
    ...
    function Ue(t, e) {
        var n = I();
        if (n && t) if ("radio" === t.type) for (var o = n.querySelectorAll('[name="'.concat(y.radio, '"]')), i = 0; i < o.length; i++) o[i].disabled = e; else t.disabled = e
    }
        ...
        return a((function t() {
            ...
            key: "_main", value: function (t) {
                ...
                if (function (t) {
                    ...
                    var n = re.swalPromiseResolve.get(v.currentInstance), o = v.currentInstance.isAwaitingPromise;
                    v.currentInstance._destroy(), o || n({isDismissed: !0}), J() && ae()
                }
    ...
    })), Yn.DismissReason = $t, Yn.version = "11.12.0";
    var io = Yn;
