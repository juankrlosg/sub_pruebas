        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Cobertura</strong> Fenix Networks</h2>
                        </div>
                        <div class="body">
                            <div class="alert alert-warning" role="alert">
                                <div class="container">
                                    ...
                                    <strong>Atención!</strong> La cobertura esta sujeta a disponibilidad y puede verse afectada o restringida por elementos como vegetación y/o construcciones.
                            ...
                            <iframe src="https://www.google.com/maps/d/u/1/embed?mid=14fAgd3jrixn4wKWEQNVfp2N5YzN9z14&ehbc=2E312F" width="100%" height="480"></iframe>
                        </div>
                    </div>
                </div>
            </div>
